	...
	<c:choose>
		...
		<!-- show가 y면 -->	
			...
			<form name="form1" id="form1" method="post">
				...
				<table border="1">
				<tr><th>번호</th><td>${dto.bno }</td></tr>
				<tr><th>제목</th><td><input name="title" id="title" size="80" value="${dto.title}" placeholder="제목을 입력해주세요"></td></tr>
				<tr><th>글쓴이</th><td>${dto.userName}</td></tr>
				<tr><th>내용</th><td><textarea name="content" id="content" rows="4" cols="80" placeholder="내용을 입력해주세요">${dto.content}</textarea></td><tr>
				</table>
				<!-- 첨부파일 목록 -->
				<div>
					첨부파일 
